 ...
 * generated by Xtext
 */
package dk.itu.smdp.survey.xtext.formatting;
...
public class TacoFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private TacoGrammarAccess _tacoGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._tacoGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._tacoGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._tacoGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._tacoGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._tacoGrammarAccess.getML_COMMENTRule();
