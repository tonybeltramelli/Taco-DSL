 ...
 * <ul>
 *   <li>{@link SurveyModel.impl.StepImpl#getQuestions <em>Questions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StepImpl extends MinimalEObjectImpl.Container implements Step {
	...
	protected EClass eStaticClass() {
		return SurveyModelPackage.Literals.STEP;
	}
	...
	public EList<Question> getQuestions() {
		if (questions == null) {
			questions = new EObjectContainmentEList<Question>(Question.class, this, SurveyModelPackage.STEP__QUESTIONS);
		}
		return questions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SurveyModelPackage.STEP__QUESTIONS:
