...
public class MainActivity extends AbtractActivity implements View.OnClickListener, TextWatcher
{
	Button _startButton;
	...
	{
		boolean flag = true;
		// check all editTexts. if all of them have text enable the start
		// button.
